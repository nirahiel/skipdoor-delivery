...
[Skipdoor Delivery](https://steamcommunity.com/sharedfiles/filedetails/?id=ToDo) is a [RimWorld](https://rimworldgame.com/) patch for the [Vanilla Psycasts Expanded](https://steamcommunity.com/sharedfiles/filedetails/?id=2842502659) mod. When two skipdoors belonging to the same network are placed on top of stockpile zones, items surrounding the skipgate will be teleported automatically to the stockpile zone with the highest priority. This can be used to take your hard-earned loot back to your base, or even to move items around the colony. 
