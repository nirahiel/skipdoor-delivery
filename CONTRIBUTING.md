...
Please use the [issue tracker](https://gitlab.com/joseasoler/skipdoor-delivery/-/issues) or the [bug reports thread in the Steam Workshop](https://steamcommunity.com/workshop/filedetails/discussion/2804121197/3274690571067124957/) to report bugs.

Questions
---

Questions about the mod can be asked in the discussion thread in the [Steam Workshop](https://steamcommunity.com/sharedfiles/filedetails/?id=2854735284) or using the [issue tracker](https://gitlab.com/joseasoler/skipdoor-delivery/-/issues).


Contributions
---

The project and its contributions are managed using the [GitLab Flow](https://docs.gitlab.com/ee/topics/gitlab_flow.html). Before submitting a merge request for a feature, create an issue on the [tracker](https://gitlab.com/joseasoler/skipdoor-delivery/-/issues) to allow for discussing and refining the idea prior to its implementation.
